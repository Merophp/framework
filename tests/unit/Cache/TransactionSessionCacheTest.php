...
/**
 * @covers \Merophp\Framework\Cache\TransactionSessionCache
 */
final class TransactionSessionCacheTest extends TestCase{
    /**
    ...
    public static function setUpBeforeClass():void{
        self::$cacheInstance = ObjectManager::get(TransactionSessionCache::class);
        self::$cacheInstance->setCacheHash(uniqid());
    }
    ...
    public function testGrab(){
        ...
        $result = self::$cacheInstance->grab();
        $this->assertFalse(self::$cacheInstance->has('key1'));
